...
Some large data files are tracked with **Git LFS**. Make sure you have it installed before cloning, otherwise you'll get small pointer files instead of the actual data.
